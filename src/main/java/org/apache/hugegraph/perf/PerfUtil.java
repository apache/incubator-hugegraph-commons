...
public final class PerfUtil {
    ...
    private PerfUtil() {
        ...
        this.root = newStopwatch(Stopwatch.Path.ROOT_NAME,
    ...
    protected static Stopwatch newStopwatch(String name,
    ...
    public String toJson() {
        ...
        sb.append('{');
        for (Map.Entry<Stopwatch.Path, Stopwatch> w :
             this.stopwatches.entrySet()) {
            sb.append('"');
            sb.append(w.getKey());
            sb.append('"');
