...
public class ReflectionUtilTest extends BaseUnitTest {
    ...
    public void testGetMethodsAnnotatedWith() {
        ...
        methods = ReflectionUtil.getMethodsAnnotatedWith(TestClass.Sub.class,
    ...
    public void testSuperClasses() throws NotFoundException {
        List<String> classes = ReflectionUtil.superClasses(TestClass.Sub.class.getName());
        Assert.assertEquals(2, classes.size());
        classes.sort(String::compareTo);
        Assert.assertEquals(Object.class.getName(), classes.get(0));
        Assert.assertEquals(TestClass.Base.class.getName(), classes.get(1));
    }
    ...
    public void testNestedClasses() throws NotFoundException {
        ...
        classes.sort(String::compareTo);
        Assert.assertEquals(TestClass.Bar.class.getName(), classes.get(0));
        Assert.assertEquals(TestClass.Base.class.getName(), classes.get(1));
        Assert.assertEquals(TestClass.Foo.class.getName(), classes.get(2));
        Assert.assertEquals(TestClass.ManuallyProfile.class.getName(), classes.get(3));
        Assert.assertEquals(TestClass.Sub.class.getName(), classes.get(4));
    }
